...
namespace ZomboidDiscordBot
{
    public class program
    {
        ...
        public async Task RunAsync(IHost host)
        {
            ...
            prefixCommands.AddModule<ZomboidDiscordBot.Modules.PrefixModule>();
            ...
            _client.Ready += async () =>
            {
                ...
                if (IsDebug())
                    ...
                    // If not debug, register commands to zomboid discord
                    await commands.RegisterCommandsToGuildAsync(UInt64.Parse(config["zomboidguild"]), true);
            };
